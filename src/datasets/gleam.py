...
def fetch_gleam(args, root):
    ...
    def _munge_and_split(root, seed, test_size, seq_len):
    ...
    client_datasets = _munge_and_split(os.path.join(root, 'gleam'), args.seed, args.test_size, args.seq_len)
