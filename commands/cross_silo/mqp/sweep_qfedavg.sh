...
python3 main.py \
--exp_name "[SWEEP] MQP_qFedAvg (q=0.1)" --seed 1 --device cuda:2 \
...
python3 main.py \
--exp_name "[SWEEP] MQP_qFedAvg (q=1.0)" --seed 1 --device cuda:2 \
--dataset MQP --max_workers 4 \
--split_type pre --test_size 0.2 \
--model_name DistilBert --use_pt_model --use_model_tokenizer --num_layers 1 --dropout 0.1 \
...
python3 main.py \
--exp_name "[SWEEP] MQP_qFedAvg (q=5.0)" --seed 1 --device cuda:2 \
--dataset MQP --max_workers 4 \
--split_type pre --test_size 0.2 \
--model_name DistilBert --use_pt_model --use_model_tokenizer --num_layers 1 --dropout 0.1 \
