...
python3 main.py \
--exp_name "[SWEEP] Berka_AFL (lambda_lr=0.01)" --seed 1 --device cuda:0 \
--dataset Berka \
...
python3 main.py \
--exp_name "[SWEEP] Berka_AFL (lambda_lr=0.1)" --seed 1 --device cuda:1 \
--dataset Berka \
--split_type pre --test_size 0.2 \
--model_name LogReg --num_layers 1 \
...
python3 main.py \
--exp_name "[SWEEP] Berka_AFL (lambda_lr=1.0)" --seed 1 --device cuda:2 \
--dataset Berka \
--split_type pre --test_size 0.2 \
--model_name LogReg --num_layers 1 \
